...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        view()->composer('*', function ($view) 
        {
            ...
            ])->where('status',1)->orderBy('sort_order','ASC')->orderBy('id','ASC')->get(['id','name','imagehome','avatar','slug','content','sort_order'])->map(function ($query) {
            ...
            $view->with([
                ...
                'blogCate'=>$blogCate,
               'hottour' => $hottour,
               'servicecatehome' => $servicecatehome,
               'tagCate' => $tagCate
                ]);    
        });  
    }
