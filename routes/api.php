...
Route::group(['namespace'=>'Api','middleware'=>'auth:api'],function(){
	...
	Route::group(['prefix'=>'bill_tour','namespace'=>'Bill'], function(){
		Route::post('list','BillTourController@list');
		Route::get('detail/{id}','BillTourController@detail');
		Route::get('delete/{id}','BillTourController@delete');
	});
	Route::group(['prefix'=>'bill_service','namespace'=>'Bill'], function(){
		Route::post('list','ServiceBookingController@list');
		Route::get('detail/{id}','ServiceBookingController@detail');
		Route::get('delete/{id}','ServiceBookingController@delete');
	});
	...
	Route::group(['prefix'=>'product', 'namespace'=>'Product'], function(){
		...
		Route::get('listtags','ProductController@listTags');
	...
	Route::group(['prefix'=>'blog', 'namespace'=>'Blog'], function(){
		...
		Route::post('import-csv','BlogController@importCsv');
