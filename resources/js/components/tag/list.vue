              ...
              <vs-table :data="list">
                ...
                <template slot-scope="{data}">
                  <vs-tr :key="indextr" v-for="(tr, indextr) in data">
                    ...
                    <vs-td :data="tr.name">{{ languageName(tr.name) }}</vs-td>
                    <vs-td :data="tr.id" v-if="tr.cate_tag != null">{{ languageName(tr.cate_tag.name) }}<div v-if="tr.cate_pro!= null">({{ languageName(tr.cate_pro.name) }})</div></vs-td>
                    <vs-td :data="tr.id" v-if="tr.cate_tag == null">--Danh mục không tồn tại--</vs-td>
...
export default {
  ...
  methods: {
    ...mapActions(["listTag","destroyTag", "loadings"]),
    closePop(event) {
