        ...
        <div class="col-md-12 grid-margin stretch-card">
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <router-link class="nav-link" :to="{name:'add_tag'}">
              ...
              <div class="con-tablex vs-table--not-data">
                ...
                <table class="vs-table vs-table--tbody-table tag-list-table">
                  ...
                  <tbody>
                    ...
                    >
                      ...
                      <td>
                        ...
                        <template v-if="tr.cate_tag != null">

                          {{ languageName(tr.cate_tag.name) }}

                          <div v-if="tr.cate_pro != null">({{ languageName(tr.cate_pro.name) }})</div>

                        </template>

                        <template v-else>--Danh mục không tồn tại--</template>
                      ...
                      <td class="action-cell" @dragstart.stop>
                        ...
                        <router-link :to="{name:'edit_tag',params:{id:tr.id}}">
...
export default {
  ...
  methods: {
    ...
    ...mapActions(["listTag","destroyTag", "sortTag", "loadings"]),
    ...
    listTags() {
      ...
      this.listTag({ keyword: this.keyword })
