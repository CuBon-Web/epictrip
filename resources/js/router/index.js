...
let _routers = [
            ...
            },
            {
                name: 'bill_tour',
                path: '/bill_tour',
                component: _import('billtour/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'bill_tour_detail',
                path: '/bill_tour/detail/:id',
                component: _import('billtour/detail'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'bill_service',
                path: '/bill_service',
                component: _import('billservice/list'),
                meta: {
                    requiresAuth: true,
                }
            },
            {
                name: 'bill_service_detail',
                path: '/bill_service/detail/:id',
                component: _import('billservice/detail'),
                meta: {
                    requiresAuth: true,
                }
            },
