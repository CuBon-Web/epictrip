<!-- HEADER START -->
<header class="sticky-header site-header header-style-3 mobile-sider-drawer-menu">

  <div class="header-style-3-area">
      <div class="header-style-top-bar">
          <div class="header-style-top-bar-left">
              <div class="trv-tp-slogn">
                 {{$setting->company}}
              </div>
          </div>
          <div class="header-style-top-bar-right">
              <div class="header-style-top-bar-mail">
                  <i class="bi bi-envelope"></i>{{$setting->email}}
              </div>
          ...
          <div class="main-bar">  
              ...
              <div class="nav-animation header-nav navbar-collapse collapse d-flex justify-content-end">
                ...
                <ul class=" nav navbar-nav">
                  <li><a href="{{route('home')}}">{{getLanguage('welcome')}}</a>
                  </li>
                  <li class="has-child">
                    <a href="javascript:;">{{getLanguage('about')}}</a>
                    <ul class="sub-menu">
                       <li><a href="{{route('aboutUs')}}">{{getLanguage('about')}}</a></li>
                       <li><a href="{{route('fags')}}">{{getLanguage('faq')}}</a></li>
                 ...
                 {{-- <li class="has-child"><a href="javascript:;">{{getLanguage('service')}}</a>
                  ...
                  <li class="has-child"><a href="javascript:;">{{ languageName($item->name) }}</a>
                      <ul class="sub-menu">
                          @foreach ($item->tags as $tag)
                          <li><a href="{{route('allListTags',['tag'=>$tag->slug])}}">{{ languageName($tag->name) }}</a></li>
                          @endforeach
                      </ul>                                                                 
                  </li>
                  @endforeach
              ...
              <div class="extra-nav header-1-nav">
                       ...
                       <li>
                         <a href="javascript:;" class="gt-lang-toggle" aria-label="Language switcher" style="display:inline-flex; align-items:center; justify-content:space-between; min-width:60px; height:30px; border:2px solid #d8d8d8; border-radius:6px; color:#ffffff; padding:0 12px; font-size:12px;">
                           <span class="gt-lang-current">
                             <img width="20" height="20" src="{{ $flagMap[$currentLang]['src'] }}" alt="{{ $flagMap[$currentLang]['alt'] }}">
                           </span>
                           <span style="margin-left:0px; font-size:11px; color:#085196;">&#9662;</span>
                         </a>
                         <ul class="gt-lang-menu" style="display:none; list-style:none; margin:6px 0 0; padding:4px 0; position:absolute; top:100%; left:70px; min-width:45px; border:2px solid #d8d8d8; border-radius:6px; z-index:1000; background-color: #000000;">
                           @foreach ($flagMap as $code => $flag)
                             <li><a href="{{ route('languages', ['lang' => $code]) }}" data-lang="{{ $code }}" style="display:block; padding:6px 12px; color:#ffffff;"><img width="20" height="20" src="{{ $flag['src'] }}" alt="{{ $flag['name'] }}"></a></li>
                           @endforeach
                         </ul>
                       </li>
                     </ul>
                  ...
                  <div class="extra-cell three trv-r-section-block-btn">
                      <a href="tel:{{$setting->phone1}}" class="site-button butn-bg-shape">Hotline</a>
                  </div>
              </div>
           ...
           <div class="extra-nav header-1-nav">
            <div class="extra-cell one">
               <div class="trv-hdr-1-social">
                ...
                <ul class="gt-lang-dropdown" style="list-style:none; margin:0; padding:0; position:relative;">
                  <li>
                    <i style="color:#ffffff;">Language</i>
                    <a href="javascript:;" class="gt-lang-toggle" aria-label="Language switcher" style="display:inline-flex; align-items:center; justify-content:space-between; min-width:60px; height:30px; border:2px solid #d8d8d8; border-radius:6px; color:#ffffff; padding:0 12px; font-size:12px;">
                      <span class="gt-lang-current">
