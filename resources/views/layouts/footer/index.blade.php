   ...
   <div class="container">
       <div class="footer-top">
           <div class="row">
               ...
               <div class="col-xl-2 col-lg-6 col-md-6 col-sm-4 col-4 m-b20">
                   <div class="widget widget_services">
                       <h3 class="widget-title">{{getLanguage('support')}}</h3>
                       <ul>
                           ...
                           <li><a href="{{ route('pagecontent', ['slug' => $item->slug]) }}">{{ languageName($item->title) }}</a></li>
                           @endif
                           @endforeach
       ...
       <div class="footer-bottom">
           <div class="container text-center">
               <div class="copyrights-text">© {{ $copyrightYear }} Epic travel All Rights Reserved. Designed by Tuấn Anh Dev</div>
           </div>   
       </div>   
   </div>
   <!-- FOOTER COPYRIGHT -->
