...
<div class="page-content">
		...
		<div class="wt-bnr-inr-entry">
			<div class="banner-title-outer">
				<div class="banner-title-name">
					<h2 class="wt-title">{{getLanguage('about')}}</h2>
				</div>
				<!-- BREADCRUMB ROW -->                            
				<div>
		...
		<div class="trv-guide-bx1-section">
			<div class="container">
				...
				<div class="section-head trv-head-title-wrap center-position">
					<h2 class="trv-head-title"> {{getLanguage('team_title')}}</h2>
					<div class="trv-head-discription">{{getLanguage('team_description')}}</div>
	...
	<div class="section-full p-t120 p-b90 trv-popular-destination tvr-hot-ballon-wrap"
            ...
            <div class="container">
                <!-- TITLE START-->
                <div class="section-head trv-head-title-wrap center-position">
                    <h2 class="trv-head-title">{!!getLanguage('popular_destination')!!}</h2>
